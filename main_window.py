...
from views.db_table import DataBaseTable
from config import PAGES
from views.file_table import FileTable
...
class MainWindow(QMainWindow, QtStyleTools):
    ...
    def __init__(self, db: DataBaseEngine = None):
        ...
        for page, name in PAGES:
            ...
            getattr(self, page).triggered.connect(getattr(self, f'{page}_page'))
    ...
    def document_page(self):
        self.Window = TableView(
            table=DataBaseTable(self, db=self.db, table='document')
        )
        self.setCentralWidget(self.Window)
        self.show()
